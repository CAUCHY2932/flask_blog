...
from .forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, ResetPasswordForm, RequestResetForm
...
def home():
    ...
    # return render_template('home.html', title='主页', posts=posts)
